...
@if ($errors->any())   <div class="alert alert-danger">       <ul>           @foreach ($errors->all() as $error)           <li>{{ $error }}</li>           @endforeach       </ul>   </div>   <br />    @endif
        ...
        <form action=" {{route('admin.comics.store')}} " method="post" enctype="multipart/form-data">
            ...
            <div class="form">
                ...
                <input class="form-control" type="text" name="artista" id="artista">
                @error('artista')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form">
                ...
                <input class="form-control" type="text" name="scrittore" id="scrittore">
                @error('scrittore')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form">
                ...
                <div>
                    <input type="date" class="form-control" name="rilasciato_il" id="rilasciato_il" value="">
                </div>
                @error('rilasciato_il')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="form">
                ...
                <input class="form-control" type="text" name="numero_pagine" id="numero_pagine">
                @error('numero_pagine')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form">
                ...
                <input class="form-control" type="text" name="targhet" id="targhet">
                @error('targhet')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
